...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('frontend') }}/assets/css/skins/skin-demo-8.css">
    <link rel="stylesheet" href="{{ asset('frontend') }}/assets/css/demos/demo-8.css">
